...
<i>Используя бот, вы автоматически соглашаетесь с Условиями сервиса и Политикой конфиденциальности. Читать: 💬 Поддержка.</i>""",
...
<i>Обычно проверка занимает не более 5 минут.</i>""",
    ...
    #
    # ИСПРАВЛЕНО: переименовано с PAYMENT_SBP_INSTRUCTIONS
    # на PAYMENT_YOOKASSA_INSTRUCTIONS.
    #
    # YooKassa — универсальная платёжная страница.
    # Пользователь видит все способы оплаты:
    # карты, СБП, кошельки, QR-коды.
    #
    "PAYMENT_YOOKASSA_INSTRUCTIONS": """💳 <b>Оплата</b>
...
Напишите нам — решим за 2 минуты.""",
    ...
    #
    # ИСПРАВЛЕНО: переименовано с PAYMENT_SBP_UNAVAILABLE
    # на PAYMENT_YOOKASSA_UNAVAILABLE.
    #
    "PAYMENT_YOOKASSA_UNAVAILABLE": """⚠️ Оплата временно недоступна.
