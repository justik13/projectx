...
Пригласите друзей по вашей ссылке, чтобы они появились здесь.""",
    ...
    # ═══ НОВОЕ (Спринт 3): тексты истёкшей подписки ═══
...
<i>Обычно это занимает несколько секунд.</i>""",
    ...
    # ═══ НОВОЕ (Спринт 3): дополнительные тексты устройств ═══
...
<i>Обычно проверка занимает не более 5 минут.</i>""",
    ...
    "PAYMENT_SBP_INSTRUCTIONS": """💳 <b>Оплата через СБП (Система Быстрых Платежей)</b>
...
Напишите нам — решим за 2 минуты.""",
    ...
    "PAYMENT_STARS_INVOICE_TITLE": "Доступ на {duration_days} дней ({device_limit} устр.)",
    "PAYMENT_STARS_INVOICE_DESCRIPTION": "Оплата цифрового доступа к защищённым конфигурациям сети.",
    "PAYMENT_STARS_INVOICE_LABEL": "Доступ к сети",

    # ═══ НОВОЕ (Спринт 3): короткие тексты платежей ═══
...
Если вы считаете, что это ошибка, свяжитесь с поддержкой.""",
    ...
    # ═══ НОВОЕ (Спринт 3): тексты уведомлений ═══
...
Все ваши созданные устройства продолжают работать в обычном режиме. Лимит генераций обновится в 00:00. Если у вас возникли трудности с настройкой, пожалуйста, обратитесь в <b>💬 Поддержку</b>.""",
    ...
    # ============================================================
    # STARS PRE-CHECKOUT ERRORS
    # ============================================================
    "PAYMENT_STARS_ERROR_INVALID_PAYMENT": "Некорректный платёж",
    "PAYMENT_STARS_ERROR_INVALID_ID": "Некорректный идентификатор платежа",
    "PAYMENT_STARS_ERROR_NOT_FOUND": "Платёж не найден",
    "PAYMENT_STARS_ERROR_ALREADY_PROCESSED": "Платёж уже обработан",
    "PAYMENT_STARS_ERROR_CANCELLED": "Платёж отменён",
    "PAYMENT_STARS_ERROR_UNAVAILABLE": "Платёж недоступен",
    "PAYMENT_STARS_ERROR_ACCESS": "Нет доступа к этому платежу",
    "PAYMENT_STARS_ERROR_BLOCKED": "Доступ недоступен",
    "PAYMENT_STARS_ERROR_TARIFF": "Тариф недоступен",
    "PAYMENT_STARS_ERROR_MAINTENANCE": "Ведутся технические работы. Попробуйте позже.",
    "PAYMENT_STARS_ERROR_METHOD": "Некорректный способ оплаты",
    "PAYMENT_STARS_ERROR_AMOUNT": "Некорректная сумма платежа",
}