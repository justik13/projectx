...
# ============================================================
# PAYMENT SHOWCASE & RENEW
# ============================================================
PAYMENT_SHOWCASE_HEADER = (
    "💳 <b>Выбор формата подписки</b>\n\n"
    "Выберите тариф, который подходит под ваши задачи. "
    "Все серверы работают на максимальной скорости.\n"
)

PAYMENT_RENEW_HEADER = (
    "🔄 <b>Продление доступа</b>\n\n"
    "Ваш текущий тариф: <b>{tariff_name}</b>\n"
    "Активен до: <i>{valid_until}</i> (осталось {days_left})\n\n"
    "Выберите, на сколько продлить:"
)

PAYMENT_CHANGE_TARIFF_HEADER = (
    "⚙️ <b>Смена тарифа</b>\n\n"
    "Сейчас у вас подключен: <b>{tariff_name}</b> (до {valid_until})\n\n"
    "⚠️ <b>Как это работает:</b>\n"
    "🔼 <b>Апгрейд</b> (больше устройств) — применяется <b>мгновенно</b>.\n"
    "🔽 <b>Даунгрейд</b> (меньше устройств) — <b>недоступен</b> во время активной подписки. "
    "Чтобы перейти на тариф с меньшим лимитом, дождитесь окончания текущей подписки.\n"
)

PAYMENT_TARIFF_DESCRIPTION = {
    2: "📱 <b>Базовый</b> (до 2 устройств)\n<i>Для личного использования: телефон + ноутбук.</i>",
    5: "👨‍👩‍👧‍👦 <b>Семейный</b> (до 5 устройств)\n<i>Подключите всю семью или все свои гаджеты. Хит продаж!</i>",
    10: "🚀 <b>Pro</b> (до 10 устройств)\n<i>Для офиса, большой семьи и тех, кто не любит ограничения.</i>",
}

PAYMENT_DURATION_HEADER = "⏱ <b>На какой срок подключаем {tariff_name}?</b>\n"
...
PAYMENT_SUCCESS = (
    ...
    "🚀 Ваш тариф обновлен / доступ продлен.\n"
...
# ============================================================
DOWNGRADE_BLOCKED = (
    "⛔ <b>Даунгрейд недоступен</b>\n\n"
    "Сейчас у вас активна подписка с лимитом <b>{current_limit}</b> устройств.\n"
    "Переход на тариф с лимитом <b>{new_limit}</b> устройств возможен "
    "<b>только после окончания текущей подписки</b>.\n\n"
    "Чтобы не прерывать работу ваших устройств, дождитесь <i>{valid_until}</i> или выберите тариф с бо́льшим лимитом."
)
