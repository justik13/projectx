...
# ИСПРАВЛЕНО (БЛОК 4):
#
# Раньше текст был слишком коротким и не содержал кнопки поддержки.
# Теперь добавлена подсказка и кнопка.
#
PAYMENT_DELAYED = (
...
# ИСПРАВЛЕНО (БЛОК 4):
#
# Раньше ERROR_NO_SUBSCRIPTION был коротким и не содержал
# подсказки о покупке. Теперь текст понятнее.
#
...
# НОВОЕ (БЛОК 4):
#
# Разные тексты для разных ошибок создания устройства.
# Раньше все ServerUnavailable показывали один и тот же текст.
#
ERROR_SERVER_FULL = (
...
# ИСПРАВЛЕНО (БЛОК 4):
#
# Раньше ERROR_SERVER_UNAVAILABLE был общим для всех ошибок.
# Теперь это fallback для неизвестных ошибок.
#
...
# НОВОЕ (БЛОК 4):
#
# Текст для лимита устройств с подсказкой апгрейда.
#
