...
# ============================================================
DOWNGRADE_BLOCKED = (
    "⛔ <b>Невозможно выбрать этот тариф</b>\n\n"
    "Сейчас у вас активна подписка с лимитом "
    "<b>{current_limit}</b> устройств.\n"
    "Выбранный тариф поддерживает только <b>{new_limit}</b>.\n\n"
    "Чтобы перейти на этот тариф:\n"
    "• Дождитесь окончания текущей подписки\n"
    "• Или выберите тариф с бо́льшим лимитом устройств"
)
